...
public:
    ...
    struct TrackDef {
        ...
        static TrackDef Px(int px) { return { Type::Pixel, static_cast<float>(std::max(0, px)) }; }
        static TrackDef Star(float w = 1.0f) { return { Type::Star, std::max(0.0f, w) }; }
    };
    ...
    void setRowSpacing(int px) { m_rowSpacing = std::max(0, px); }
    void setColSpacing(int px) { m_colSpacing = std::max(0, px); }
