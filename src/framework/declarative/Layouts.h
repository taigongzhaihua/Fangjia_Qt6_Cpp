...
public:
    ...
    std::shared_ptr<Column> spacing(int s) {
        m_spacing = s;
        return std::static_pointer_cast<Column>(shared_from_this());
    }
...
public:
    ...
    std::shared_ptr<Row> spacing(int s) {
        m_spacing = s;
        return std::static_pointer_cast<Row>(shared_from_this());
    }
...
public:
    ...
    std::shared_ptr<Stack> alignment(Alignment align) {
        m_alignment = align;
        return std::static_pointer_cast<Stack>(shared_from_this());
    }
