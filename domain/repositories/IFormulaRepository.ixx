// IFormulaRepository.ixx - C++20 module interface for IFormulaRepository
module;

#include <vector>
#include <string>

export module fangjia.domain.repositories.formula;

import fangjia.domain.entities.formula;
